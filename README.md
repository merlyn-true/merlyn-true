...
- Rebuilding Excel/Power Query/VBA projects in **Python** + **SQL**
- Visual storytelling improvements using Power BI and matplotlib
- Automated pipelines for marketing and operational analytics

## 🌱 I’m currently learning
- Advanced data visualization and dashboard design  
- Better data modeling and ETL structure  
- Clean Python architecture for analytics workflows  

## 👯 I’m looking to collaborate on
- Small analytics projects  
- Data automation or workflow challenges  
- Visualization/UX improvements for dashboards  
